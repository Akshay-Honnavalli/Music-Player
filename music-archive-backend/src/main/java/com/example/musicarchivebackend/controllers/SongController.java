...
import com.example.musicarchivebackend.model.Artist;
...
//        return ResponseEntity.ok(songRepository.findAll());
    ...
    public ResponseEntity<?> createSong(@RequestPart("song")Song song, @RequestPart("file") MultipartFile file) throws IOException {
        // Create HttpHeaders and set the Location header to the redirect URL
//        HttpHeaders headers = new HttpHeaders();
//        headers.add("Location", "/index");

//        return artist.uploadSong(song,file);
        System.out.println("Inside createSong function !!!");
