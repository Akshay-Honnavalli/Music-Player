...
//    @GetMapping("/index/playlists")
    @RequestMapping(value = "/index/playlists", method = RequestMethod.GET)
    public String viewPlaylists(Model model,jakarta.servlet.http.HttpSession session)
    {
        ...
        List<Playlist> playlists = playlistService.getAllPlaylists((String) session.getAttribute("loggedInUser"));
    ...
    public String handlePlayListCreation(@RequestParam("playlistName") String playlistName, @RequestParam("songNames") String songNames,jakarta.servlet.http.HttpSession session)
    {
        ...
        playlistService.createPlaylist(playlistName, songList, (String) session.getAttribute("loggedInUser"));
